...
PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,device/jsr/i6/system,system)


## Misc files
PRODUCT_COPY_FILES += \
   device/jsr/i6/system/lib/liboncrpc.so:obj/lib/liboncrpc.so \
   device/jsr/i6/system/lib/libaudioalsa.so:obj/lib/libaudioalsa.so \
   device/jsr/i6/system/lib/libaudcal.so:obj/lib/libaudcal.so 
